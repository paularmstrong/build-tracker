...
const middleware = (router: express.Router, queries: Queries, handlers: Handlers): express.Router => {
  router.post('/api/builds', insertBuild(queries.build.byRevision, handlers.onBuildInsert));
